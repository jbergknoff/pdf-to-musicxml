...
| **4 — Full single staff** | key/time sig, beams, ~~multi-page~~ (done — pages recognized one at a time and stitched into one document by `lib/assembly/combine-pages.ts`); grand staff paired into two-staff part. | assembly fidelity. |
